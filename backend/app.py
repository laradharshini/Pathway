...
try:
    ...
    if cred_path and os.path.exists(cred_path):
        ...
        # Initialize with just the Project ID (limited functionality, may fail verify_id_token without ADC)
        firebase_admin.initialize_app(options={'projectId': project_id})
        print(f"✅ Firebase Admin Initialized with Project ID: {project_id} (Auth verification may require ADC)")
    else:
        # Fallback to default
